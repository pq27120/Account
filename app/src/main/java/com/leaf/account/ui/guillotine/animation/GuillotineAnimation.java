package com.leaf.account.ui.guillotine.animation;
...
import com.leaf.account.ui.guillotine.util.ActionBarInterpolator;
import com.leaf.account.ui.guillotine.util.GuillotineInterpolator;
...
public class GuillotineAnimation {
    ...
    public static class GuillotineBuilder {
        ...
        public com.leaf.account.ui.guillotine.animation.GuillotineAnimation build() {
            return new com.leaf.account.ui.guillotine.animation.GuillotineAnimation(this);
        }
    }
}
